...
var _uportDidResolver = _interopRequireDefault(require("uport-did-resolver"));
...
(0, _uportDidResolver.default)();
(0, _naclDid.registerNaclDID)();
var NOW = 1485321133;

_mockdate.default.set(NOW * 1000 + 123);

var audMnid = '2nQtiQG6Cgm1GYTBaaKAgr76uY7iSexUkqY';
var aud = "did:uport:".concat(audMnid);
...
describe('createJWT()', function () {
  ...
  describe('Ed25519', function () {
    ...
    var did = 'did:nacl:BvrB8iJAz_1jfq1mRxiEKfr9qcnLfq5DOGrBf2ERUHU';
    var signer = (0, _NaclSigner.default)(ed25519PrivateKey);
    var alg = 'Ed25519';
    it('creates a valid JWT', function () {
      return (0, _JWT.createJWT)({
        requested: ['name', 'phone']
        ...
        return expect((0, _naclDid.verifyJWT)(jwt)).toBeTruthy();
      });
    });
    it('creates a JWT with correct format', function () {
      return (0, _JWT.createJWT)({
    ...
    it('creates a JWT with expiry in 10000 seconds', function () {
      return (0, _JWT.createJWT)({
        ...
        var _decodeJWT2 = (0, _JWT.decodeJWT)(jwt),
            payload = _decodeJWT2.payload;
...
describe('verifyJWT()', function () {
  (0, _uportDidResolver.default)(function (id, cb) {
    if (mnid === id) cb(null, didDoc);
    if (audMnid === id) cb(null, ethDidDoc);
  });
  describe('pregenerated JWT', function () {
    ...
    it('verifies the JWT requiring authentication and return correct signer', function () {
      return (0, _JWT.verifyJWT)(incomingJwt, {
        auth: true
      }).then(function (_ref5) {
  ...
  describe('nacl-did jwt', function () {
    ...
    var incomingJwt = naclId.createJWT(payload);
    var publicKey = {
      id: "".concat(did, "#key1"),
    ...
    it('verifies the JWT and return correct payload', function () {
      return (0, _JWT.verifyJWT)(incomingJwt).then(function (_ref6) {
        var payload = _ref6.payload;
        return expect(payload).toEqual(payload);
      });
    });
    it('verifies the JWT and return correct profile', function () {
      return (0, _JWT.verifyJWT)(incomingJwt).then(function (_ref7) {
        var doc = _ref7.doc;
        return expect(doc).toMatchSnapshot();
      });
    });
    it('verifies the JWT and return correct did for the iss', function () {
      return (0, _JWT.verifyJWT)(incomingJwt).then(function (_ref8) {
        var issuer = _ref8.issuer;
        return expect(issuer).toEqual(naclId.did);
      });
    });
    it('verifies the JWT and return correct signer', function () {
      return (0, _JWT.verifyJWT)(incomingJwt).then(function (_ref9) {
        var signer = _ref9.signer;
        return expect(signer).toEqual(publicKey);
      });
    });
    it('verifies the JWT requiring authentication and return correct signer', function () {
      return (0, _JWT.verifyJWT)(incomingJwt, {
  ...
  it('accepts a valid iat', function () {
    return (0, _JWT.createJWT)({
      iat: NOW + _JWT.IAT_SKEW
    }, {
      issuer: did,
      signer: signer
    }).then(function (jwt) {
      return (0, _JWT.verifyJWT)(jwt).then(function (_ref11) {
  ...
  it('handles ES256K-R algorithm', function () {
    return (0, _JWT.createJWT)({
      ...
      return (0, _JWT.verifyJWT)(jwt).then(function (_ref12) {
  ...
  it('handles ES256K-R algorithm with ethereum address', function () {
    return (0, _JWT.createJWT)({
      ...
      return (0, _JWT.verifyJWT)(jwt).then(function (_ref13) {
  ...
  it('accepts a valid exp', function () {
    return (0, _JWT.createJWT)({
      exp: NOW - _JWT.IAT_SKEW + 1
    }, {
      issuer: did,
      signer: signer,
      expiresIn: 1
    }).then(function (jwt) {
      return (0, _JWT.verifyJWT)(jwt).then(function (_ref14) {
...
describe('resolveAuthenticator()', function () {
  ...
  describe('DID', function () {
    describe('ES256K', function () {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                (0, _uportDidResolver.default)(function (mnid, cb) {
              ...
              case 3:
                ...
                return _context.abrupt("return", expect(authenticators).toEqual({
      ...
      it('filters out irrelevant public keys',
      /*#__PURE__*/
      (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                return _context2.abrupt("return", expect(authenticators).toEqual({
      ...
      it('only list authenticators able to authenticate a user',
      /*#__PURE__*/
      (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                return _context3.abrupt("return", expect(authenticators).toEqual({
      ...
      it('errors if no suitable public keys exist',
      /*#__PURE__*/
      (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _context4.abrupt("return", expect((0, _JWT.resolveAuthenticator)(alg, did)).rejects.toEqual(new Error("DID document for ".concat(did, " does not have public keys for ").concat(alg))));
        ...
        return _regenerator.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                authenticators = _context5.sent;
                return _context5.abrupt("return", expect(authenticators).toEqual({
        ...
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 3:
                authenticators = _context6.sent;
                return _context6.abrupt("return", expect(authenticators).toEqual({
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                return _context7.abrupt("return", expect((0, _JWT.resolveAuthenticator)(alg, did)).rejects.toEqual(new Error("DID document for ".concat(did, " does not have public keys for ").concat(alg))));
    ...
    it('errors if no suitable public keys exist for authentication',
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              return _context8.abrupt("return", expect((0, _JWT.resolveAuthenticator)(alg, did, true)).rejects.toEqual(new Error("DID document for ".concat(did, " does not have public keys suitable for authenticationg user"))));
    ...
    it('errors if no public keys exist',
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return _context9.abrupt("return", expect((0, _JWT.resolveAuthenticator)(alg, did)).rejects.toEqual(new Error("DID document for ".concat(did, " does not have public keys for ").concat(alg))));
    ...
    it('errors if no DID document exists',
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              return _context10.abrupt("return", expect((0, _JWT.resolveAuthenticator)(alg, did)).rejects.toEqual(new Error("Unable to resolve DID document for ".concat(did))));
    ...
    it('errors if no supported signature types exist',
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              return _context11.abrupt("return", expect((0, _JWT.resolveAuthenticator)('ESBAD', did)).rejects.toEqual(new Error("No supported signature types for algorithm ESBAD")));
  ...
  describe('MNID', function () {
    it('converts MNID to DID and finds public key',
    /*#__PURE__*/
    (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
      ...
      return _regenerator.default.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 3:
              authenticators = _context12.sent;
              return _context12.abrupt("return", expect(authenticators).toEqual({
                authenticators: [ecKey1],
                issuer: did,
                doc: singleKey
              }));
